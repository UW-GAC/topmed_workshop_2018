...
The WGSA output files are tab-separated text files, with one line per annotated variant. Since there are many annotation fields, these files can be unweildy to work with directly. As an example, the first two lines of teh SNP variant annotation file can be previewed within R:
