...
```{r}
combined_annotation %>% filter(VEP_ensembl_Gene_ID != ".") %>% group_by(VEP_ensembl_Gene_ID) %>% filter(CADD_phred > 3) %>% filter(str_detect(VEP_ensembl_Consequence, "intron_variant"))
```
